...
class UpdateAutomationRequest extends FormRequest {
  ...
  public function rules(): array {
    $rules = [
      'driver_start_load' => 'nullable',
      'driver_start_load.dispatcher' => 'nullable|string',
      'driver_start_load.collaborator' => 'nullable|string',
      'driver_start_load.extra_emails' => 'nullable|array',
      'driver_start_load.extra_emails.*' => 'email|distinct',

      'driver_shipper_loaded' => 'nullable',
      'driver_shipper_loaded.dispatcher' => 'nullable|string',
      'driver_shipper_loaded.collaborator' => 'nullable|string',
      'driver_shipper_loaded.extra_emails' => 'nullable|array',
      'driver_shipper_loaded.extra_emails.*' => 'email|distinct',

      'driver_shipper_arrived' => 'nullable',
      'driver_shipper_arrived.dispatcher' => 'nullable|string',
      'driver_shipper_arrived.collaborator' => 'nullable|string',
      'driver_shipper_arrived.extra_emails' => 'nullable|array',
      'driver_shipper_arrived.extra_emails.*' => 'email|distinct',

      'driver_receiver_arrived' => 'nullable',
      'driver_receiver_arrived.dispatcher' => 'nullable|string',
      'driver_receiver_arrived.collaborator' => 'nullable|string',
      'driver_receiver_arrived.extra_emails' => 'nullable|array',
      'driver_receiver_arrived.extra_emails.*' => 'email|distinct',

      'driver_receiver_unloaded' => 'nullable',
      'driver_receiver_unloaded.dispatcher' => 'nullable|string',
      'driver_receiver_unloaded.collaborator' => 'nullable|string',
      'driver_receiver_unloaded.extra_emails' => 'nullable|array',
      'driver_receiver_unloaded.extra_emails.*' => 'email|distinct',

      'driver_end_load' => 'nullable',
      'driver_end_load.dispatcher' => 'nullable|string',
      'driver_end_load.collaborator' => 'nullable|string',
      'driver_end_load.extra_emails' => 'nullable|array',
      'driver_end_load.extra_emails.*' => 'email|distinct',

      'loadCollaboratorAddedNotification' => 'nullable|boolean',

      'schedule' => 'nullable|array',
      'schedule.id' => 'required_with:schedule|exists:automation_schedules,id',
      ...
      'schedule.freqInterval' => 'required_with:schedule|required_if:schedule.freqType,!=,once',
      ...
      'schedule.actions.*.actionType' => 'required_with:schedule|in:' . implode(',', config('constant.automation.action.actionType')),
      'schedule.actions.*.actionId' => 'nullable',
      ...
      'reminder.id' => 'required_with:reminder|exists:automation_reminders,id',
      ...
      'reminder.actions.*.actionId' => 'nullable',
      ...
      'reminder.assets.*.reminderAssetId' => 'nullable',
