...
class CreateDriverRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'type' => [
                'nullable',
                "in:" . config('constant.driver_type.employee') . "," . config('constant.driver_type.contractor')
            ],
            'name' => 'required',
            'firstName' => 'required',
            'lastName' => 'required',
            ...
            'status' => ['required', "in:" . config('constant.status.driver.active') . "," . config('constant.status.driver.inactive')],
            'driver_pay_types' => [
                'nullable',
