...
class CreateInvoiceV2Request extends FormRequest {
  /**
  ...
  public function rules(): array {
    ...
    return [
      ...
      'customerId' => 'required_if:status,' . $requestedInvoice . '|nullable|integer|exists:customers,id,company_id,' . $companyId,
      'invoiceNumber' => 'required_if:status,' . $requestedInvoice . '|nullable|string|min:1|max:255',
      'dueDate' => 'required_if:status,' . $requestedInvoice . '|nullable|date|date_format:' . config('constant.date_format'),
