...
class UpdateFieldValuesRequest extends FormRequest {
  ...
  public function rules() {
    return [
      ...
      // 'newValues.*.dateValue.utcDateOnly' => ['required_with:newValues.*.dateValue', 'date_format:Y-m-d'],
      //ToDo: Temp. solution due to a bug in the frontend
      'newValues.*.dateValue.utcDateOnly' => ['nullable', 'date_format:' . config('constant.date_format')],
