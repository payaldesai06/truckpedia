<template>
  <vx-card title="Revenue Report" id="maintenance">
    <div class="vx-row">
      <!-- Sidebar -->
      ...
      <div class="mt-base vx-col w-full">
        <DataTable :value="items"
          ...
          <Column field="company_name" header="Company Name" :sortable="true">
            ...
            <template #filter>
              <InputText type="text" v-model="filters['company_name']" class="p-column-filter w-full"/>
            </template>
          </Column>
          ...
          <Column field="date" header="Date" :sortable="true">
            ...
            <template #filter>
              <InputText type="text" v-model="filters['date']" class="p-column-filter w-full"/>
            </template>
          </Column>
