    ...
    <div class="vx-row w-full m-0">
      ...
      <div class="vx-col w-full md:w-1/2 mb-8 md:mb-0">
        ...
        <vx-card>
          ...
          <div class="vx-col w-full">
            <div class="flex items-center py-2">
              <vs-checkbox class="ml-0" v-model="automationDriverButtons">
              </vs-checkbox>
          ...
          <div class="vx-col w-full">
            <div class="flex items-center py-2">
              <vs-checkbox class="ml-0" v-model="noFactoring"> </vs-checkbox>
    ...
    createCustomer(payload) {
      ...
      this.$store
        ...
        .then((data) => {
          ...
          EventBus.$emit('customer-added', data.payload || null);
          this.$vs.notify({
            color: 'primary',
