    ...
    <div class="vx-row m-0 flex justify-between items-center w-full">
      ...
      <div class="vx-col pr-0 flex">
        <vs-button
          ...
          class="vs-con-loading__container mr-4"
    ...
    <div class="vx-row">
      <div class="vx-col w-full">
        ...
        >
          ...
          >
            <template #body="slotProps">
              {{ `${slotProps.data.paymentTermsDay} days net` }}
            </template>
            <template #filter>
              <InputText
                type="number"
                v-model="filters['paymentTermsDay']"
                @input="onInputFilter"
                class="p-column-filter"
              />
            </template>
...
export default {
  ...
  methods: {
    ...
    redirectToAddCustomer() {
      this.$router.push({ name: 'customers-add' }).catch(() => true);
    },
