<template>
  <div class="pipeline-filter">
    <div class="filter-dropdown">
      <div class="filter-btn a-icon cursor-pointer" @click="openFilterPopup" style="z-index: 100">
            ...
            >
              <div class="flex items-center p-3">
                ...
                <div
                  class="w-full"
                  v-if="
                    ['loadDispatcher', 'loadTag', 'loadDriver'].includes(
                      condition.column
                    )
                  "
                >
...
export default {
  ...
  computed: {
    ...
    columListToRender() {
      return this.columnsList.map((column) => {
        return {
          ...column,
  ...
  methods: {
    ...
    handleFun(column, index) {
      const nullFiledColumns = ["loadDispatcher", "loadTag", "loadDriver"];
    ...
    mountInitFilterData() {
      const { dispatcherIds, tagIds, driverIds } = this.value || {};
      const filterJson = {
        conditions: [],
        op: "and",
      };
