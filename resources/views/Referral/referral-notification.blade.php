                  ...
                  <tbody>
                    <tr>
                      <td valign="top" style="padding-left: 20px;padding-bottom: 20px;">
                        ...
                        <p>Hi,</p>
                        <p>Here is a new referral from {{$registeredCompanyName}}:</p>
                        <p><span style="font-weight: bold">Company Name: </span>{{$submitReferralDetails['company_name']}}</p>
                        <p><span style="font-weight: bold">Contact First Name: </span>{{$submitReferralDetails['first_name']}},
                          <span style="font-weight: bold"> Contact Last Name: </span>{{$submitReferralDetails['last_name']}}
                        </p>
                        <p><span style="font-weight: bold">Contact Phone: </span>{{$submitReferralDetails['phone']}}</p>
                        <p><span style="font-weight: bold">Contact Email: </span>{{$submitReferralDetails['email']}}</p>
                        <p><span style="font-weight: bold">State: </span>{{$submitReferralDetails['state']}}</p>
                        <p><span style="font-weight: bold">Number of Trucks: </span>{{$submitReferralDetails['number_of_trucks']}}</p>
                      </td>
                    </tr>
