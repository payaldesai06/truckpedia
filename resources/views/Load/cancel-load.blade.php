            ...
            <tr>
              <td class="wrapper">
                <table role="presentation">
                  <tr>
                    <td>
                      <h3 style="font-weight: bold">Hello {{$carrierName}},</h3>
                      <p>Load #{{$loadReference}}
                        @if(!empty($shipper) && !empty($receiver))
                        from {{$shipper->city}}, {{$shipper->state}} to {{$receiver->city}}, {{$receiver->state}}
                        @endif
                        is canceled.</p>
                      <div style="margin-top: 25px">Thanks,</div>
                      <div style="margin-bottom: 25px;">{{ $shipperBrokerName }}</div>
