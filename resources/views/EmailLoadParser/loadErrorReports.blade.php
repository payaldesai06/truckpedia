                  ...
                  <tbody>
                    <tr>
                      <td valign="top" style="padding-left: 20px;padding-bottom: 20px;">
                        ...
                        <p>Hello,</p>
                        <p>New load cannot be saved because something is wrong!</p>
                        <p>Payload: @php echo '<br>
                        <pre>'; print_r($payload); @endphp</p>
                        <p>Errors: @php echo '<br>'.(is_array($errors) ? implode('<br>',$errors) : $errors); @endphp</p>
                      </td>
                    </tr>
                  </tbody>
                </table>
