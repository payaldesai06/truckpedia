                  ...
                  <tbody>
                    <tr>
                      <td valign="top" style="padding-left: 20px;padding-bottom: 20px;">
                        ...
                        <p>Hi,</p>
                        <p>Estimate needed for {{$data['incidentClaimNumber']}}.</p>
                        <p><span style="font-weight: bold">Site: </span>{{$data['tagName']}}</p>
                        ...
                        <p><span style="font-weight: bold">Link to files: </span><a href="{{$data['link']}}">{{$data['link']}}</a></p>
                      </td>
                    </tr>
                  </tbody>
                </table>
