                  ...
                  <tbody>
                    <tr>
                      <td valign="top" style="padding-left: 20px;padding-bottom: 20px;">
                        ...
                        <p>Hi,</p>
                        <p>Incident {{$data['incidentClaimNumber']}} needs follow-up.</p>
                        <p><span style="font-weight: bold">Incident Type: </span>{{$data['incidentType']}}</p>
                        <p><span style="font-weight: bold">Incident Date: </span>{{$data['incidentDate']}}</p>
                        <p><span style="font-weight: bold">Status: </span>{{$data['status']}}</p>
                        <p><span style="font-weight: bold">Follow-up Date: </span>{{$data['followUpDate']}}</p>
