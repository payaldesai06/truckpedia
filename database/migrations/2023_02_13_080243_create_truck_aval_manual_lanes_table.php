...
class CreateTruckAvalManualLanesTable extends Migration {
  /**
   * Run the migrations.
   *
   * @return void
   */
  public function up() {
    Schema::create('truck_aval_manual_lanes', function (Blueprint $table) {
      $table->id();
      $table->foreignId('truck_aval_rpt_sched_id')->nullable()->constrained('truck_aval_rpt_scheds')->cascadeOnDelete();
  ...
  public function down() {
    Schema::dropIfExists('truck_aval_manual_lanes');
  }
}
