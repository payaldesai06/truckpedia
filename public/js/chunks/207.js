...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/pages/carriers/components/FilesTab.vue?vue&type=script&lang=js&":
/*!********************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/pages/carriers/components/FilesTab.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_10__["mapGetters"])('customerV2', ['getFolderList']), {
    customerId: function customerId() {
      return this.isEditMode && this.dataObj ? parseInt(this.dataObj.customer_id) : null;
    },
    files: function files() {
      ...
      return this.getFolderList.map(function (folder) {
        ...
        } else if (_this.dataObj && _this.dataObj.files && _this.dataObj.files.length > 0) {
          files = _this.dataObj.files.filter(function (file) {
            return file.folderId === folder.id;
          });
        }
  ...
  methods: {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 10:
                ...
                this.$vs.notify({
                  ...
                  color: 'danger',
                  title: 'Error',
                  text: Object(_helpers_helper__WEBPACK_IMPORTED_MODULE_11__["getApiErrorMsg"])(_context.t0)
                });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return this.$store.dispatch('customerV2/fetchFolderList');
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return this.$store.dispatch('customerV2/fetchFiles', this.customerId);
    ...
    addFolder: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.mark(function _callee4(_ref2) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                isEdit = _ref2.isEdit, id = _ref2.id, folderName = _ref2.folderName;
                _context4.prev = 1;
                ...
                _context4.next = 5;
                return this.$store.dispatch('customerV2/updateFolder', {
                  folderId: id,
              ...
              case 7:
                _context4.next = 9;
                return this.$store.dispatch('customerV2/createFolder', {
                  folderName: folderName
                });
              ...
              case 13:
                ...
                return this.$vs.notify({
                  ...
                  color: 'danger',
                  title: 'Error',
                  text: Object(_helpers_helper__WEBPACK_IMPORTED_MODULE_11__["getApiErrorMsg"])(_context4.t0)
                });
    ...
    generateS3NameAndURL: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.mark(function _callee5(files) {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 3:
                _context5.next = 5;
                return Object(_helpers_helper__WEBPACK_IMPORTED_MODULE_11__["getFileExtension"])(files);

              case 5:
                allFiles = _context5.sent;
                _context5.next = 8;
                return this.$store.dispatch('customerV2/getUploadUrls', {
                  files: allFiles
                });
              ...
              case 8:
                ...
                return _context5.abrupt("return", result && payload ? payload : []);
    ...
    uploadAttachmentsToS3: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.mark(function _callee7(s3FileNameAndURL, files) {
        var _this2 = this;

        var _ret;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.wrap(function _callee7$(_context8) {
          while (1) {
                    ...
                    while (1) {
                      switch (_context7.prev = _context7.next) {
                        case 0:
                          ...
                          _this2.$vs.loading({
                            text: s3FileNameAndURL.length > 1 ? loadingText(1, 0) : "".concat(_this2.uploadPercentage, "%")
                          });
                          ...
                          _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.mark(function _loop(i) {
                            var _s3FileNameAndURL$i, fileName, url, file, _ref4, status;

                            return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.wrap(function _loop$(_context6) {
                              while (1) {
                                switch (_context6.prev = _context6.next) {
                                  case 0:
                                    ...
                                    file = files[i];
                                    _context6.next = 4;
                                    return _this2.$store.dispatch('uploadFileToS3ViaPresignedUrl', {
                                      url: url,
                                      file: file,
                                      extension: fileName.split('.').pop(),
                                      onUploadProgress: function onUploadProgress(progressEvent) {
                                        _this2.uploadPercentage = parseInt(Math.round(progressEvent.loaded * 100 / progressEvent.total)); // Get loader text by class name and update the text

                                        var h4 = document.getElementsByClassName('title-loading')[0];

                                        if (h4) {
                                          h4.innerText = s3FileNameAndURL.length > 1 ? loadingText(i + 1, _this2.uploadPercentage) : "".concat(_this2.uploadPercentage, "%");
                                        }
                                      }
                                    });
    ...
    uploadFiles: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.mark(function _callee8(_ref5) {
        var folderId, files, s3FileNameAndURL, attachments, payload, _payload, _files;

        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.wrap(function _callee8$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 10:
                ...
                _context9.next = 15;
                return this.$store.dispatch('customerV2/uploadFiles', payload);
              ...
              case 24:
                ...
                this.$vs.notify({
                  ...
                  color: 'danger',
                  title: 'Error',
                  text: Object(_helpers_helper__WEBPACK_IMPORTED_MODULE_11__["getApiErrorMsg"])(_context9.t1)
                });
    ...
    deleteFile: function () {
      ...
      /*#__PURE__*/
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.mark(function _callee9(_ref6) {
        var id, index, payload;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.wrap(function _callee9$(_context10) {
          while (1) {
            switch (_context10.prev = _context10.next) {
              case 0:
                id = _ref6.file.id, index = _ref6.index;
                _context10.prev = 1;
                ...
                payload = {
                  files: this.dataObj.files.filter(function (_, i) {
                    return i !== index;
                  })
                };
              ...
              case 6:
                _context10.next = 8;
                return this.$store.dispatch('customerV2/deleteFile', id);
              ...
              case 13:
                ...
                this.$vs.notify({
                  ...
                  color: 'danger',
                  title: 'Error',
                  text: Object(_helpers_helper__WEBPACK_IMPORTED_MODULE_11__["getApiErrorMsg"])(_context10.t0)
                });
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/pages/carriers/components/FilesTab.vue?vue&type=template&id=5c7378f8&":
/*!******************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/pages/carriers/components/FilesTab.vue?vue&type=template&id=5c7378f8& ***!
  \******************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./resources/js/src/views/pages/carriers/components/FilesTab.vue":
/*!***********************************************************************!*\
  !*** ./resources/js/src/views/pages/carriers/components/FilesTab.vue ***!
  \***********************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _FilesTab_vue_vue_type_template_id_5c7378f8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./FilesTab.vue?vue&type=template&id=5c7378f8& */ "./resources/js/src/views/pages/carriers/components/FilesTab.vue?vue&type=template&id=5c7378f8&");
/* harmony import */ var _FilesTab_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./FilesTab.vue?vue&type=script&lang=js& */ "./resources/js/src/views/pages/carriers/components/FilesTab.vue?vue&type=script&lang=js&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _FilesTab_vue_vue_type_template_id_5c7378f8___WEBPACK_IMPORTED_MODULE_0__["render"],
  _FilesTab_vue_vue_type_template_id_5c7378f8___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/***/ "./resources/js/src/views/pages/carriers/components/FilesTab.vue?vue&type=script&lang=js&":
/*!************************************************************************************************!*\
  !*** ./resources/js/src/views/pages/carriers/components/FilesTab.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/src/views/pages/carriers/components/FilesTab.vue?vue&type=template&id=5c7378f8&":
/*!******************************************************************************************************!*\
  !*** ./resources/js/src/views/pages/carriers/components/FilesTab.vue?vue&type=template&id=5c7378f8& ***!
  \******************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_FilesTab_vue_vue_type_template_id_5c7378f8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!../../../../../../../node_modules/vue-loader/lib??vue-loader-options!./FilesTab.vue?vue&type=template&id=5c7378f8& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/pages/carriers/components/FilesTab.vue?vue&type=template&id=5c7378f8&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_FilesTab_vue_vue_type_template_id_5c7378f8___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_loaders_templateLoader_js_ref_6_node_modules_vue_loader_lib_index_js_vue_loader_options_FilesTab_vue_vue_type_template_id_5c7378f8___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
